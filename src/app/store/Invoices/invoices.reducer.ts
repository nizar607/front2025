...
import { addInvoiceDataSuccess, deleteinvoiceSuccess, fetchInvoiceData, fetchInvoiceFailure, fetchInvoiceSuccess, fetchInvoicelistData, fetchInvoicelistFailure, fetchInvoicelistSuccess } from './invoices.action';
...
export const InvoiceReducer = createReducer(
    ...
    on(addInvoiceDataSuccess, (state, {newData}) => {
        console.log('new invoice added : ', newData);
        return {...state, caseData: [newData, ...state.Invoicedata], error: null};
      }),
)
