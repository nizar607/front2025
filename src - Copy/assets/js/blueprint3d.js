            ...
            Floorplan.prototype.assignOrphanEdges = function () {
                ...
                this.walls.forEach(function (wall) {
                    if (!wall.backEdge && !wall.frontEdge) {
                        wall.orphan = true;
                        var room = null;
                        var back = new Model.HalfEdge(room, wall, false);
                        back.generatePlane();
                        var front = new Model.HalfEdge(room, wall, true);
                        front.generatePlane();
...
(function (BP3D) {
    ...
    (function (Three) {
        Three.Edge = function (scene, edge, controls) {
            ...
            var texture = null;
            var lightMap = THREE.ImageUtils.loadTexture("assets/rooms/textures/walllightmap.png");
            ...
            function updateTexture(callback) {
                ...
                var maping = null;
                texture = THREE.ImageUtils.loadTexture(url, maping, callback);
                if (!stretch) {
...
(function (BP3D) {
    ...
    (function (Three) {
        Three.Main = function (model, element, canvasElement, opts) {
            ...
            function init() {
                console.log("id", urlParams.split("=")[1]);
    ...
    var Blueprint3d = (function () {
        ...
        function Blueprint3d(options) {
            if (!options.textureDir)
                console.warn("No texture directory specified.");
            else
            ...
            if (!options.widget && options.floorplannerElement) {
