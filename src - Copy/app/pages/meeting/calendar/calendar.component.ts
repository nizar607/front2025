...
import {fetchmeetingData} from 'src/app/store/Meeting/meeting.action';
import {selectData} from 'src/app/store/Meeting/meeting.selector';
  ...
  ngOnInit() {
    ...
    setTimeout( () => {
      this.store.select(selectData).subscribe((data) => {
        this.logger.info("data here ",data);
      });
    },3000);
